...
function parseTime(str: string) {
  ...
  // Validate and fix invalid minutes
  const minuteNum = parseInt(minute);
  if (minuteNum >= 60) {
    minute = "00";
  } else if (minuteNum % 5 !== 0) {
    // Round to nearest 5-minute interval
    minute = (Math.round(minuteNum / 5) * 5).toString().padStart(2, "0");
  }
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.pickerRow}>
            ...
            <View style={styles.pickerCol}>
              <Text style={styles.label}>{t("study_plan.startTime")}</Text>
            ...
            {/* End Time */}
            <View style={styles.pickerCol}>
              <Text style={styles.label}>{t("study_plan.endTime")}</Text>
              <Text style={styles.selectedTime}>
                {endHour}:{endMinute}
              </Text>
              <View style={styles.pickerWrap}>
